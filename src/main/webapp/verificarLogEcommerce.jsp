<%-- 
    Document   : verificarLogEcommerce
    Created on : Feb 27, 2024, 6:52:22 PM
    Author     : JFerreira
--%>
...
<%
    ...
    try {
        ...
        String[] cmd = {"sudo", "-u", "root", "/opt/tomcat/webapps/dockpos/buscaLogEcommerce.exp", ip, numeroBoleta};
        ...
        String file = numeroBoleta + "-ecommerce.log";
